...
### Login
Vault Toolbox requires you to authenticate into a Vault. You can do this using the <b>Vault DNS</b> (```your_vault_name.veevavault.com```) and either the combination of your <b>Username</b> and <b>Password</b> or you can supply an active <b>Session ID</b>. SSO Authentication is possible by obtaining the <b>Session ID</b> via the Vault REST API using [OAuth 2.0 / OpenID Connect](https://developer.veevavault.com/api/23.3/#oauth-2-0-openid-connect) (see [Vault Help](https://platform.veevavault.help/en/gr/43329/) for more information).

#### Login: Vault-aware Login Form
If you open Vault Toolbox from a Vault, it will automatically copy the <b>Vault DNS</b> into the Login Form for you.
...
In order to use Vault Toolbox, users must have the following permissions:
